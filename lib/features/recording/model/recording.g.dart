...
Recording _recordingDeserialize(
  ...
  final object = Recording(
    ...
    id: id,
    milliSeconds: reader.readLongOrNull(offsets[1]),
...
extension RecordingQueryFilter
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> milliSecondsEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'milliSeconds',
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> milliSecondsBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'path',
      ));
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'path',
      ));
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathEqualTo(
    String? value, {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'path',
        value: '',
  ...
  QueryBuilder<Recording, Recording, QAfterFilterCondition> pathIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'path',
        value: '',
...
extension RecordingQuerySortBy on QueryBuilder<Recording, Recording, QSortBy> {
  ...
  QueryBuilder<Recording, Recording, QAfterSortBy> sortByMilliSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milliSeconds', Sort.asc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> sortByMilliSecondsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milliSeconds', Sort.desc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> sortByPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.asc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> sortByPathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RecordingQuerySortThenBy
  ...
  QueryBuilder<Recording, Recording, QAfterSortBy> thenByMilliSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milliSeconds', Sort.asc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> thenByMilliSecondsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milliSeconds', Sort.desc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> thenByPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.asc);
    });
  }

  QueryBuilder<Recording, Recording, QAfterSortBy> thenByPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.desc);
    });
  }
...
extension RecordingQueryWhereDistinct
  ...
  QueryBuilder<Recording, Recording, QDistinct> distinctByMilliSeconds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'milliSeconds');
    });
  }

  QueryBuilder<Recording, Recording, QDistinct> distinctByPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension RecordingQueryProperty
  ...
  QueryBuilder<Recording, int?, QQueryOperations> milliSecondsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'milliSeconds');
    });
  }

  QueryBuilder<Recording, String?, QQueryOperations> pathProperty() {
    return QueryBuilder.apply(this, (query) {
